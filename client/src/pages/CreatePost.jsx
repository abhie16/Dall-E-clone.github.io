    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          Create imaginative posts with DALL-E AI and share them with the community.
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit} action="">
        ...
        <div className='mt-10'>
            <p className='mt-2 text-[#666e75] text-[14px]'> Once you have created image, you can share it with the community.
            </p>  
             <button type='submit'
